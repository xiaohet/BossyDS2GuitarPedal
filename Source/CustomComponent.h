/*
  ==============================================================================
    ...
    CustomComponent.h
    Author:  Xiaohe Tian
    In reference to "CustomComponent.h" by Joshua Hodge.
...
static constexpr float fontHeight { 12.0f };
...
public:
    ...
    SliderWithLabel (juce::String labelName, juce::String paramId, juce::AudioProcessorValueTreeState& apvts, const int width, const int height, juce::String unit, SliderStyle style = SliderStyle::Rotary);
